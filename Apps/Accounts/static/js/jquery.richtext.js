...
(function ($) {
    ...
    $.fn.richText = function (options) {
        ...
        function init() {
            ...
            $editor = $('<div />', {class: "richText dark:richText"});
        ...
        settings.$editor.find('.richText-help').on('click', function () {
            ...
            if ($editor) {
                ...
                $content.append('<h3 style="margin:0;">Descripción</h3>');
                $content.append('<h3 style="margin:0;">En este cuadro de texto podrá escribir las observaciones del anteproyecto del alumnado.</h3>');
